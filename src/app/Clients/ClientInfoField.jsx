...
function ClientInfoField({title1="",content1="",title2="",content2=""}) {
  ...
  return (
    <div className='  md:text-base text-xs flex md:flex-row flex-col justify-center md:items-center items-evenly w-full  min-h-[70px] border-b-[1px] border-gray-400 '>
